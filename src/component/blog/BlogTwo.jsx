...
function BlogTwo() {
    return (
        <div>
            ...
            <div className="rts-blog-area rts-section-gap2Bottom bg-3">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="title-style-three-left border-bottom-blog">
                                <span>Blog</span>
                                <h3 className="title-sm quote">
                    ...
                    <div className="row g-5 mt--40 rts-slide-up">
                        <div className="col-xl-6 col-lg-12">
                            ...
                            <div className="blog-style-three">
                                <Link href="/blog/10" className="thumbnail">
                                    <img data-aos="move-left" data-aos-delay="100" src="assets/images/blog/04.jpg" alt="blog" />
                                </Link>
                                <div className="body-information">
                                    ...
                                    <Link href="/blog/10" className="btn-read-more-blog">
                        ...
                        <div className="col-xl-6 col-lg-12">
                            ...
                            <div className="blog-style-three">
                                <Link href="/blog/11" className="thumbnail">
                                    <img data-aos="move-left" data-aos-delay="100" src="assets/images/blog/05.jpg" alt="blog" />
                                </Link>
                                <div className="body-information">
                                    <div className="blog-top">
                                        <span className="tag">Architecture </span>
