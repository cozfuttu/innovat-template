                    ...
                    <div className="row g-5 mt--50">
                        <div className="col-lg-3 col-md-4 col-sm-6 col-12">
                            ...
                            <div className="team-style-three">
                                <a href="/team-single" className="thumbnail">
                        ...
                        <div className="col-lg-3 col-md-4 col-sm-6 col-12">
                            ...
                            <div className="team-style-three">
                                ...
                                <div className="bottom-content">
                                    <span className="name">Architect</span>
                                    <a href="#">
                        ...
                        <div className="col-lg-3 col-md-4 col-sm-6 col-12">
                            ...
                            <div className="team-style-three">
                                ...
                                <div className="bottom-content">
                                    <span className="name">Architect</span>
                                    <a href="#">
                                        <h6 className="title">Thomas Leo</h6>
                                    </a>
                                </div>
                                <div className="social-style-team-h">
                                    <ul>
                        ...
                        <div className="col-lg-3 col-md-4 col-sm-6 col-12">
                            ...
                            <div className="team-style-three">
                                ...
                                <div className="bottom-content">
                                    <span className="name">Designer</span>
                                    <a href="#">
                                        <h6 className="title">Charlotte Luna</h6>
                                    </a>
                                </div>
                                <div className="social-style-team-h">
                                    <ul>
                        ...
                        <div className="col-lg-3 col-md-4 col-sm-6 col-12">
                            ...
                            <div className="team-style-three">
                                ...
                                <div className="bottom-content">
                                    <span className="name">Designer</span>
                                    <a href="#">
                                        <h6 className="title">Michael Henry</h6>
                                    </a>
                                </div>
                                <div className="social-style-team-h">
                                    <ul>
                        ...
                        <div className="col-lg-3 col-md-4 col-sm-6 col-12">
                            ...
                            <div className="team-style-three">
                                <a href="/team-single" className="thumbnail">
                                    <img src="assets/images/team/09.jpg" alt="team" />
                                </a>
                                <div className="bottom-content">
                                    <span className="name">Architect</span>
                                    <a href="#">
                                        <h6 className="title">Daniel Jack</h6>
                                    </a>
                                </div>
                                <div className="social-style-team-h">
                                    <ul>
